...
class Dashboard extends CI_Controller{
	...
	{    
		...
		$this->data['dashboard_details']  = $this->admin_panel_model->dashboard_details($times);		
		$this->data['today_oders_list']  = $this->admin_panel_model->today_orders($times);		
        $this->data['page'] = 'index';        
        $this->load->vars($this->data);
        $this->load->view($this->data['theme'].'/template');
	}
    	...
    	if(!empty($result))
		{
			...
			{   
				 ...
				 //   echo "posted time :" .$time ;
					...
					$time_zone = ($time_zone!="")?$time_zone:'Asia/Calcutta'; 
