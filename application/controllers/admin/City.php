...
class City extends CI_Controller{
    ...
    public function add_city()
    {
        ...
        $pop = $this->input->post('popular_city');
        ...
        $check_data=$this->admin_panel_model->insert_city($data);
        
        
        if($check_data)
        {
          
              // $this->admin_panel_model->insert_city($data);
        $this->session->set_flashdata('message','Your data is Successfully added.');
        }
        else
        {
             $this->session->set_flashdata('alert','State and city is already exit.');
    ...
    public function city_set_operation()
{
     ...
     $operation=$this->input->post("operation");
       $this->admin_panel_model->city_status_update($ids,$operation);
        // $this->admin_panel_model->delete_users_post_dsp($ids,$operation); 
         // redirect(base_url().'admin/manage-city');
}
}
?>