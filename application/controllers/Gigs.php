...
$this->data["banners"]=$this->gigs_model->get_banner_image($time_to_string2,$addon_value_2["values"]);
...
foreach($data_get_for_update as $date_esc)
{
  ...
  $this->data['page_title'] = 'EscortsOz';
...
public function price_table_for()
{
  ...
  // $days_set="2019-3-2";
// var_dump("FOR MONTH =".Date('d-M-Y', strtotime("+".$days_set." month")));

// $days_set=2;
// var_dump("FOR DAY =".Date('d-M-Y', strtotime("+".$days_set." day")));


// $days_set=7*2;
// var_dump("FOR WEEK =".Date('d-M-Y', strtotime("+".$days_set." day")));


// $days_set=365*2;
// var_dump("FOR YEAR =".Date('d-M-Y', strtotime("+".$days_set." day")));
