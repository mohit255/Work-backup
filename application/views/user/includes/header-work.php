...
<?php 
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
   ...
   <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/scrolbar.css">
...
<!-- One Signal -->
 <script src="https://cdn.onesignal.com/sdks/OneSignalSDK.js" async></script>
  ...
  ol.mp_list { z-index:111;  margin-top:40px !important; background-color: #FFFFFF; color:#000000 !important; border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; overflow: hidden; position: absolute; width: 100%; height:auto; overflow:-y; z-index: 111 !important; padding-left:0px; text-align: left; }
  ol.mp_list1 { z-index:111;  margin-top:50px !important; background-color: #FFFFFF; color:#000000 !important; border-left: 1px solid #C0C0C0; border-right: 1px solid #C0C0C0; overflow: hidden; position: absolute; width: 100%; height:auto; overflow:-y; z-index: 111 !important; padding-left:0px; text-align: left; }
   /* Each list item, regardless of success, error, etc. */ 
   ol.mp_list li { border-bottom: 1px solid #C0C0C0; padding: 0px 0; list-style-type: none;}
    /* Each list item from a successful request. */ 
    ol.mp_list li.mp_item {  width: 100%; font: 16px'Oswald', sans-serif; text-indent: 12px; } /* Each list item that's selectable. */ ol.mp_list li.mp_selectable { cursor: pointer; } /* Currently highlighted list item. */ ol.mp_list li.mp_highlighted { background-color: #4ac102; width: 100%; } /* When a request is made that returns zero results. */ ol.mp_list li.mp_no_results { } /* When a request is made that doesn't meet the 'minChars' length option. */ ol.mp_list li.mp_min_chars { } /* When a request is made that fails during the ajax request. */ ol.mp_list li.mp_error { }
...
.loder {
   width: 100%;
    ...
    height: 100%;
    top: 0px;
    background: url(https://upload.wikimedia.org/wikipedia/commons/7/7a/Ajax_loader_metal_512.gif) 50% 50% no-repeat rgb(249,249,249);
       }
...
.divider {
  ...
  .set_border_color{
    ...
    .set_class_for_bd_dsp{
      background-color:#4ac102 !important;
    }
  </style>
</head>
<body> 
	<div id="main-wrapper">
      ...
      $user_id = $this->session->userdata('SESSION_USER_ID');              
		$query = $this->db->query("SELECT `username` , user_thumb_image , fullname, are_you FROM `members` WHERE `USERID` = $user_id ");
    ...
    <!-- after login -->
                ...
                <div class="">
                 <div class="">
                  ...
                  <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><h1 style="margin-top: 0px;"><img src="<?php 

                     if(!empty($logo['value']))  echo base_url().$logo['value']; else { echo base_url()."assets/images/logo.png";   }?>" class="logo1" alt="logo" width="133" height="133" /></h1></a>
                  </div>
                </div>
                <div class="col-md-4">


                     <?php  if($module=="gigs" || $module=="") {
     ...
     <div class="input-group" id="adv-search" style="width: 100%;">
                ...
                <input type="text" class="form-control search-box mp_input" required="" name="quick_search" placeholder="Type a niche or keyword..." aria-autocomplete="list" aria-owns="mp_quick_search_list" autocomplete="off" role="combobox" aria-required="false" style="height: 38px !important; margin-top: 12px; border-top-left-radius: 20px;border-bottom-left-radius: 20px;"><ol class="mp_list1" aria-atomic="true" aria-busy="false" aria-live="polite" id="mp_quick_search_list" role="listbox" style="display: none;"></ol><ol class="mp_list1" aria-atomic="true" aria-busy="false" aria-live="polite" id="mp_quick_search_list" role="listbox" style="display: none;"></ol>
                <div class="input-group-btn">
                    <div class="btn-group" role="group">
                        <div class="dropdown dropdown-lg">
                            
                        </div>
                        <button type="submit" class="btn btn-primary search-btn" style="height: 38px !important; width: auto; border-top-right-radius: 20px;border-bottom-right-radius: 20px;"><span class="" aria-hidden="true">SEARCH</span></button>
                    </div>
                </div>
            </div>
          </form>
                  ...
                  <div class="collapse navbar-collapse" id="myNavbar">
                    <!-- <ul class="nav navbar-nav"> -->
                      <div class="main-site-menu visible-desktop">
                        <ul class="nav navbar-nav pc-menu navbar-right"> 
                          <li>
                            <a href="index.html"><i class="icon-home"></i></a>
                          </li>
                          <!-- <li>
                            <a href="blog.php">BECOME AN INFLUENCER</a>
                          </li> -->
                          <li id="menu-5" class="dropdown <?php if($module == 'message') echo 'active'; ?>">
                            <a href="<?php echo base_url().'message'; ?>"><i class="fa fa-envelope "></i>
                             <span class="badge badge-success pull-right" id="new_message_count" style="display: none;"></span>  
                            </a>
                            <div id="message_notification"></div>
                          </li>
                          <li id="menu-6"  class="dropdown <?php if($module == 'notification') echo 'active'; ?>">
                          ...
                          <!-- <li id="menu-7" class="dropdown  <?php if($module == 'password' || $module == 'profile' || $module == 'payment_settings' ) echo 'active'; ?> ">
                            <a href="<?php echo base_url().'password'; ?>"><i class="fa fa-cogs"></i></a> -->
                          ...
                          <!-- use for profile -->
                          <li id="menu-8" class="dropdown <?php if($module == 'purchases' || $module == 'my_gigs' || $module == 'sales' || $module == 'payments' || $module == 'user_profile' ) echo 'active'; ?> ">
                           ...
                           <img class="menu-pro-img" src="<?php echo $header_user_image ; ?>" alt="<?php echo $header_user_fullname ; ?>" title="<?php echo $header_user_fullname ; ?>" width="50" height="50">
                            ...
                            <ul class="dropdown-menu">
                              <?php if(@$result["are_you"]=="Long") { ?>  
                             <li><a href="<?php echo base_url().'purchases'; ?>">My Purchases</a></li>
                               <?php } else {  ?>

                            <li><a href="<?php echo base_url().'my-packages'; ?>">My Packages</a></li>
                              ...
                              <!-- <li <?php if($module == 'sell_service') echo 'active'; ?>"><a href="<?php echo base_url().'sell-service'; ?>">Sell Service</a></li>
                              <li <?php if($module == 'buy_service') echo 'active'; ?>"><a href="<?php echo base_url().'buy-service'; ?>">Buy Service</a></li> -->
           ...
           <input type="hidden" name="types" value="categories"> 
  <div class="input-group" id="adv-search" style="width: 100%;">
                <input type="text" class="form-control search-box mp_input" name="quick_search" placeholder="Type a niche or keyword..." aria-autocomplete="list" aria-owns="mp_quick_search_list" autocomplete="off" role="combobox" aria-required="false" style="height: 38px !important; margin-top: 12px; border-top-left-radius: 20px;border-bottom-left-radius: 20px;"><ol class="mp_list" aria-atomic="true" aria-busy="false" aria-live="polite" id="mp_quick_search_list" role="listbox" style="display: none;"></ol><ol class="mp_list" aria-atomic="true" aria-busy="false" aria-live="polite" id="mp_quick_search_list" role="listbox" style="display: none;"></ol>
                <div class="input-group-btn">
                    <div class="btn-group" role="group">
                        <div class="dropdown dropdown-lg">
                  ...
                  <div class="collapse navbar-collapse" id="myNavbar">
                    <!-- <ul class="nav navbar-nav"> -->
                        ...
                        <ul class="nav navbar-nav pc-menu navbar-right"> 
                          ...
                          <li class="become">
                            <a href="<?php echo base_url(); ?>pages/For_Influencers_" class="become">BECOME AN INFLUENCER</a>
                          </li>
                          <li class="loin">
                            <a href="javascript:;"  data-toggle="modal" data-target="#login-popup" style="margin-top: 5px;">LOG IN</a>
                          </li>
                          <li class="promoted">
                            <a href="<?php echo base_url(); ?>signup" class="btn submit-button button_submit dynamic-button ">CREATE ACCOUNT</a>
                          </li> 
                        </ul>  
                        </div>
                    </div>
					...
					<div class="modal-body">
						...
						<form id="users_login" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-lg-8">
									<input type="text" class="form-control" name="user_name" id="user_name" placeholder="Email" required>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<div class="col-lg-6"><a href="#" class="pull-left forgot" data-toggle="modal" data-target="#forgot-popup" style="font-weight: bold; color:#1874c6;">Forgot password?</a></div>
								<div class="col-lg-6"><button type="submit" class="btn btn-primary logon-btn pull-right">Login</button></div>
							</div>
						</form>
					</div>
					<!-- <div class="modal-footer text-center">
						<div class="modal-footer-text">Not a member yet? <a href="" data-toggle="modal" data-target="<?php echo base_url(); ?>signup" style="font-weight: bold; color:#1874c6;">Register now</a> - it’s fun and easy!</div>
					</div> -->

<div class="modal-footer text-center">
            <div class="modal-footer-text">Not a member yet? <a href="<?php echo base_url(); ?>signup" style="font-weight: bold; color:#1874c6;">Register now</a> - it’s fun and easy!</div>
          </div>
		...
		<div id="forgot-popup" class="modal fade custom-popup" role="dialog" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer text-center">
						<div class="modal-footer-text">Do you know your password? <a href="" data-toggle="modal" data-target="#login-popup" style="font-weight: bold; color:#1874c6;">Login now</a> - it’s fun and easy!</div>
					</div>
				</div>
			</div>
		</div>
