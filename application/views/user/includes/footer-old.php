		...
		<div class="row">
			<div class="container">
				 <div class="col-md-2 col-md-offset-1">
				  ...
				  <li class=""><p style="text-align: left; line-height: 26px; font-size: 16px;"><font color="#626262"><a href="<?php echo base_url().'pages/'; ?>">Help Center</a></font></p></li>
				  <br>
				   <li class=""><p style="text-align: left; line-height: 26px; font-size: 16px;"><font color="#626262"><a href="<?php echo base_url().'pages/'; ?>">About Us</a></font></p></li>
				   <br>
				    <li class=""><p style="text-align: left; line-height: 26px; font-size: 16px;"><font color="#626262"><a href="<?php echo base_url().'pages/'; ?>">Contact Us</a></font></p></li>
				    <br>
				     <li class=""><p style="text-align: left; line-height: 26px; font-size: 16px;"><font color="#626262"><a href="<?php echo base_url().'pages/'; ?>">Blog</a></font></p></li><br>
...
<li><p style="text-align: left; line-height: 26px; font-size: 16px;"><font color="#626262"><a href="<?php echo base_url().'pages/'.$sub_menu['footer_submenu']; ?>"><?php echo str_replace('_',' ',$sub_menu['footer_submenu']); ?></a></font></p></li><br>
 ...
 <script type="text/javascript" src="<?php echo base_url(); ?>assets/js/popper.min.js"></script>
	...
	<?php if($module=="purchases"  || $module=="my_gigs") { ?>
