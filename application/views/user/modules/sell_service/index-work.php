...
&nbsp;
				...
				<div class="container">				
					...
					<div class="row milestone-section">
						...
						<div class="col-sm-2 text-center">
							...
							<p class="miles-title">Create your package</p>
			...
			<section id="post_gig_area" class="post-gig-area">	
				...
				<div class="container">		
					...
					<div class="row">
						...
						<div class="col-md-8 col-sm-12">                                                   
							...
							<h3 class="post-gig-title">Post a package in few seconds</h3>

							<!-- <p class="sub-title">Package: a packed service you can deliver remotely or  around you for a fixed price in a set time frame.</p> -->
							...
							<form id="sell_service"   action="<?php echo base_url()."user/sell_service/add_gigs"; ?>" method="post" class="sell-service-form" enctype= "multipart/form-data" >
								...
								<div class="form-group clearfix">
									...
									<label class="label-title">Title for your package <span class="required">*</span></label>
									...
									<small class="error_msg help-block gig_price_error" style="display: none;">Please enter the price for package</small>
								...
								<label class="label-title">When will you deliver the package? <span class="required">*</span></label>
               ...
               <input type="text" name="delivering_time" id="delivering_time" class="form-control" placeholder="Just type number of days (ex : 2 Days)"><span class="actual_delivery_days" id="main_delivery_days"> </span>
								...
								<div class="form-group clearfix">
									...
									<label class="label-title">Pick Category <span class="required">*</span><small class="error_msg help-block gig_category_id_error" style="display: none;">Please select a category</small></label>
								...
								<div class="form-group add-image clearfix">
									...
									<div class="upload-block">
                                        ...
                                        <div class="photos-upload" data-toggle="modal" data-target="#avatar-gig-modal2">
								...
								<div class="form-group item-description clearfix">
									...
									<label class="label-title">Provide more details about your package <span class="required">*</span></label>
									...
									<small class="error_msg help-block  gig_details_error" style="display: none;">Please enter about your package details</small>
...
<div class="name-block2">
	...
	<span class="sub_delivery_days">Day</span></span>                                                
				...
				<small class="error_msg help-block extra_gigs_validate" style="display: none;" >Please enter the price for extra package</small>

				<small class="error_msg help-block extra_gigs_gig_name" style="display: none;" >Please enter the package name </small>
				...
				<div class="delivery-block clearfix">                                                                                   
					...
					<div class="checkbox checkbox-primary checkbox-inline pull-left">
						...
						<input type="checkbox" name="super_fast_delivery" class="validdays" id="super_fast_delivery" value="yes"  >
				...
				<small class="error_msg help-block super_fast_priece_error" style="display: none;" >Please enter a super fast price</small>
								...
								<div class="form-group select-condition clearfix">
									...
									<div class="buyer-option">
										...
										<small class="error_msg help-block work_option_error set_border_color" style="display: none;" >Please select any option</small>
                                ...
                                <small class="error_msg help-block terms_conditions_error" style="display: none; margin-bottom: -18px !important;">Please accept terms & conditions</small><br>
								<div class="form-group agreement clearfix" style="display: inline-flex;">

									<div class="checkbox set_class_dsp checkbox-primary checkbox-inline" style="margin-bottom: 62px; width:10px;">
									...
									I will update or pause my package if I can no longer meet this delivery time.<br>
									...
									entitle the Buyer to a refund. See <a href="<?php echo base_url().'t&c'?>" target="_blank" class="chk-link"> T&amp;Cs </a></p><br><br>
								...
								<a href="javascript:void(0)" onclick="sell_services_add()" class="btn btn btn-primary sell_service_submit"  >Submit</a> 
...
<div class="modal fade" id="avatar-gig-modal2" aria-hidden="true" aria-labelledby="avatar-modal-label" data-backdrop="static" data-keyboard="false" role="dialog">
		...
		<div class="modal-content">   
			...
			<div class="modal-body">
				...
				<div class="image-editor">
					...
					<input class="" id="video_files" name="gig_video" size="20" type="file">
					
                         <div class="modal-footer" style="border: none;">
					        <button class="btn btn-primary close" data-dismiss="modal">Done</button>
					      </div>
...
<div id="myModalSuccessRegistration3" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p style="    text-align: center; font-weight: bold; margin-top: 50px; font-size: 16px;"><?php echo @$this->session->flashdata('message'); ?></p>
      </div>
      <div class="modal-footer" style="border:none;">
...
<script type="text/javascript">
    $(window).on('load',function(){
      ...
      $('#myModalSuccessRegistration3').modal({
    backdrop: 'static',
    keyboard: false
})
        $('#myModalSuccessRegistration3').modal('show');
