						...
						<div class="col-sm-4 rightsidebar">
							...
							<div class="view-right">
								...
								<div class="order-btn theiaStickySidebar" >
                                    ...
                                    <a href="#" class="btn btn-primary" onclick="check_extra_gigs()" data-toggle="modal" data-target="#checkout-popup">Buy now  <?php echo $rate_symbol ;?><span id="over_all_totalbtn-primary"><?php echo $rate; ?></span></a>

                                     <?php } else {  ?>

                                         

    <a href="<?php echo base_url()."edit-package/".$gig_details['title']."/".$gig_details['id']; ?>" class="btn btn-primary"  > Edit Package </a>    

                                   <?php   }  } else { $gig_title = $this->uri->segment(2); ?>

                                      <a href="javascript:;" class="btn btn-primary" onclick="selected_menu('package-preview/<?php echo $gig_title.'/'.$this->uri->segment(3); ?>')" >Buy now  <?php echo $rate_symbol ;?><span id="over_all_total"><?php echo $rate; ?></span></a>
                                                                                ...
                                                                                <li class="seller-contact"><!-- <img alt="views" src="<?php echo base_url()."assets/images/contact.png";?>" width="33" height="33">   -->                                                                             
                                                                                  ...
                                                                                  <?php if(($this->session->userdata('SESSION_USER_ID')))  { 
                                                                                    ...
                                                                                    <a href="javascript:;" data-toggle="modal" data-target="#message-popup">
                                                                                         <i class="fa fa-comment"></i>&nbsp;<h5>Contact Seller</h5></a>

                                                                                  <?php } else { ?>

                                                                                    <a href="javascript:;" onclick="selected_menu('sell-service')" ><i class="fa fa-comment"></i>&nbsp; <h5>Contact Seller</h5></a>
								...
								<div class="seller-info">
									...
									<ul class="gig-stats seller-stats">
										...
										<li class="seller-views"><i class="fa fa-eye"></i> &nbsp;<h5><?php echo $gig_details['total_views']; ?> Views</h5></li>

										<li class="seller-orders"><i class="fa fa-database"></i> &nbsp;<h5><?php echo count($result_countid);?> order in queue</h5></li>
<?php if(@$social_link) { ?>
                                        <li class="seller-speaks social-list1">
                                       
                    <?php if(@$social_link["facebook"]) { ?>
     <a href="<?php echo @$social_link["facebook"]; ?>"><span class="fa fa-facebook set_class_for_bd_dsp" style="padding: 9px 11px 9px 11px; margin-bottom: 4px;"></span></a>
                    <?php } ?>
                   ...
                   <a href="<?php echo @$social_link["podcast"]; ?>"><span class="fa fa-podcast set_class_for_bd_dsp"></span></a>
                    ...
                    <span class="fa fa-twitter"></span> -->
										...
										<li class="seller-speaks"><i class="fa fa-globe"></i> &nbsp;<h5>Speaks: <?php echo ucfirst($user_profile['lang_speaks']); ?></h5></li>
...
<!-- 								<div class="similiar-gigs"> 
									...
									<h3>Similiar Packages <span class="similar-gig-all"><a href="<?php echo base_url()."search/category?search_value=".$similar_gigs ; ?>"> see all </a> </span></h3>                                    
                    ...
                    <?php if ($stripe_allow == 1) { ?>  
                     ...
                     <?php } ?>                   
								...
								<div>
									...
									<button type="submit" id="payment_btn" style="display: none;" class="btn btn-green buyitnow-btn" value="true" name="submit">Buy now</button>
						...
						<div class="modal-footer text-left">
							...
							<div class="media secure-money">
								...
								<div class="media-body">
									...
									<span>Your deposit will be securely held in influencer until you are happy to release it to the Seller upon completion.</span>
