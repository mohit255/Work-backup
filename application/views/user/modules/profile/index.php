	...
	<div class="loading" aria-label="Loading" role="img" tabindex="-1"></div> 
			...
			<?php if(!empty($country_name)) { ?>				
				<li class="user-country2">FROM <?php echo $country_name; ?> <span class="ppcn country <?php echo $country_shortname; ?>"></span></li> <?php } ?>
						...
						<p class="user-desc" style="border:none;"> <?php echo ucfirst($profile['description']); ?> <span class="more-desc"></span></p>
						</div>
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <?php if(@$profile["are_you"]=="Short") { ?> 
						...
						<li>
							<a href="<?php echo base_url().'social-profile'; ?>">
								<span class="visible-xxs"><i class="fa fa-money" aria-hidden="true"></i></span>
...
<div class="tab-content">
	...
	<input type="text"  name="user_name" id="user_name" class="form-control" value="<?php echo $profile['fullname']; ?>" required >
								...
								<input type="hidden"  name="last_name" id="last_name" class="form-control" value="<?php echo $profile['lname']; ?>" required >
								<!-- <div class="col-sm-3">
									<div class="form-group">
				...
				<?php if(@$profile["are_you"]=="Short") { ?>
		<option value="Short">Influnecer</option>
           <?php } else { ?>
          ...
          <?php } ?> 	
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
										<label>Videos:</label>
									<input type="hidden" name="old_videos" value="<?php echo @$profile["videos"]; ?>">	
										<input type="file" name="videos_name" accept=".mp4,.3gp,.wmv,.avi,.mov,.ogg" id="user_addr" class="form-control">
									</div>
						</div>
					</div>		
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										...
										<textarea  name="user_desc" id="user_desc" class="form-control" cols="5" rows="5"><?php echo $profile['description']; ?></textarea>
									</div>
								</div>
							</div>
