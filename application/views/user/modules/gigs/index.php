...
foreach ($banners as $get_user) {
    if($get_user["user_addon_id"])
    {
      array_push($user_order_banner_1, $get_user["USERID"]);
    }
    else
    {
...
// var_dump($user_order_banner_1);
// arsort($user_order_banner_1);
$get_data_for_banners_get=$this->db->query("SELECT user_id as USERID FROM `user_addon` WHERE `user_id` IN ('".implode("','",$user_order_banner_1)."') ORDER BY `user_addon`.`id` ASC");
// var_dump($this->db->last_query());
$get_data_for_banners=$get_data_for_banners_get->result_array();
$user_order_banner=array_merge($get_data_for_banners,$user_order_banner_2);

          for($k=0; $k<count($user_order_banner); $k++) {
// var_dump($user_order_banner[$k]["USERID"]);

               $data=$this->db->query("select * from user_login where USERID='".$user_order_banner[$k]["USERID"]."'")->row_array();
            
             $cover_image='assets/uploads/default/'.$default_cover_image["name"];
             if(@$data["cover_image"])
             {
                                          ...
                                          <div class="panel panel-default saale-tum-pe-ek-js-nhi-lg-hri-he">
                                             <div class="panel-heading saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                <h4 class="panel-title saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                   <a data-toggle="collapse" class="saale-tum-pe-ek-js-nhi-lg-hri-he collapsed" href="#collapseOne" aria-expanded="false"><span class="glyphicon glyphicon-folder-close saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                   </span> Ethnicity</a>
                                                </h4>
                                             </div>
                                    ...
                                    <div class="col-md-6 col-xs-12 saale-tum-pe-ek-js-nhi-lg-hri-he">
                                       <div class="panel-group" id="accordion">
                                          <div class="panel panel-default saale-tum-pe-ek-js-nhi-lg-hri-he">
                                             <div class="panel-heading saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                <h4 class="panel-title saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                   <a data-toggle="collapse" class="saale-tum-pe-ek-js-nhi-lg-hri-he collapsed" href="#collapsetwo" aria-expanded="false"><span class="glyphicon glyphicon-folder-close saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                   </span> Body Type</a>
                                                </h4>
                                             </div>
                                 ...
                                 <div class="col-md-3 saale-tum-pe-ek-js-nhi-lg-hri-he">
                                    <div class="panel-group" id="accordion">
                                       <div class="panel panel-default saale-tum-pe-ek-js-nhi-lg-hri-he">
                                          <div class="panel-heading saale-tum-pe-ek-js-nhi-lg-hri-he">
                                             <h4 class="panel-title saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                <a data-toggle="collapse" class="saale-tum-pe-ek-js-nhi-lg-hri-he collapsed" href="#collapsethree" aria-expanded="false"><span class="glyphicon glyphicon-folder-close saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                </span> Bust Size</a>
                                             </h4>
                                          </div>
                                 ...
                                 <div class="col-md-3 saale-tum-pe-ek-js-nhi-lg-hri-he">
                                    <div class="panel-group" id="accordion">
                                       <div class="panel panel-default saale-tum-pe-ek-js-nhi-lg-hri-he">
                                          <div class="panel-heading saale-tum-pe-ek-js-nhi-lg-hri-he">
                                             <h4 class="panel-title saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                <a data-toggle="collapse" class="saale-tum-pe-ek-js-nhi-lg-hri-he collapsed" href="#collapsefour" aria-expanded="false"><span class="glyphicon glyphicon-folder-close saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                </span> Hair Style</a>
                                             </h4>
                                          </div>
                                 ...
                                 <div class="col-md-3 saale-tum-pe-ek-js-nhi-lg-hri-he">
                                    <div class="panel-group" id="accordion">
                                       <div class="panel panel-default saale-tum-pe-ek-js-nhi-lg-hri-he">
                                          <div class="panel-heading saale-tum-pe-ek-js-nhi-lg-hri-he">
                                             <h4 class="panel-title saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                <a data-toggle="collapse" class="saale-tum-pe-ek-js-nhi-lg-hri-he collapsed" href="#collapsefive" aria-expanded="false"><span class="glyphicon glyphicon-folder-close saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                </span> Escort For</a>
                                             </h4>
                                          </div>
                                 ...
                                 <div class="col-md-3 saale-tum-pe-ek-js-nhi-lg-hri-he">
                                    <div class="panel-group" id="accordion">
                                       <div class="panel panel-default saale-tum-pe-ek-js-nhi-lg-hri-he">
                                          <div class="panel-heading saale-tum-pe-ek-js-nhi-lg-hri-he">
                                             <h4 class="panel-title saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                <a data-toggle="collapse" class="saale-tum-pe-ek-js-nhi-lg-hri-he collapsed" href="#collapsesix" aria-expanded="false"><span class="glyphicon glyphicon-folder-close saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                </span> Rates From</a>
                                             </h4>
                                          </div>
  ...
  <?php 
   ...
   $age_filter=$this->db->query("select * from dropdown where name='dropdown8'")->row_array();
                                        ?>    
                                          <div class="panel-heading saale-tum-pe-ek-js-nhi-lg-hri-he">
                                             <h4 class="panel-title saale-tum-pe-ek-js-nhi-lg-hri-he">
                                                <a data-toggle="collapse" class="saale-tum-pe-ek-js-nhi-lg-hri-he" href="#collapseseven"><span class="glyphicon glyphicon-folder-close saale-tum-pe-ek-js-nhi-lg-hri-he">
...
if(($i+1)==count($age_filter_array))
{
 ...
 ?> 
                        <li class="saale-tum-pe-ek-js-nhi-lg-hri-he ik-or-class-set-ki-he">
<input class="filter saale-tum-pe-ek-js-nhi-lg-hri-he ik-or-class-set-ki-he" data-filter="" type="radio" name="<?php echo strtolower(@$age_filter["title"]);  ?>" value="<?php echo @$age_filter_array[$i];  ?>" id="asian_age_<?php echo @$i;  ?>">
...
<?php } ?>
                                 ...
                                 <div class="col-md-3 col-md-offset-1 saale-tum-pe-ek-js-nhi-lg-hri-he">
                                    <div class="advertiser-search__col-submit advertiser-search__col-submit--top saale-tum-pe-ek-js-nhi-lg-hri-he">
                                       <label class="label label-primary saale-tum-pe-ek-js-nhi-lg-hri-he" for="available_data"> <input class="filter saale-tum-pe-ek-js-nhi-lg-hri-he ik-or-class-set-ki-he" data-filter="" type="checkbox" name="available" value="Available" id="available_data"> Available Now</label>
                                    </div>
                                 </div>
                              </div>
                           </div>
...
<section class="letest_escorts">
   <div class="s-results-header">
      <div class="container">
        ...
        $package_name=$this->db->query("select name from  membership where id='".$data["package_id"]."'")->row_array();
        $photo_varify=$this->db->query("select photo_status from  escort_info where escort_id='".$data["USERID"]."'")->row_array();
  if($package_name["name"]=='Silver')
  {
   continue;
  }
                   $profile_image='assets/uploads/default/'.$default_profile_image["name"];
               ...
               <div class="swiper-slide swipe-img">
                  ...
                  <div class="carousel-item__item-details">
                     ...
                     <span class='verified-label'>Photos <?php  if(@$photo_varify["photo_status"]) echo @$photo_varify["photo_status"]; else { echo "Unverified"; } ?></span>
                  </div>
               </div>
               <?php } } ?>
...
foreach ($get_all_user as $get_user) {
    if($get_user["user_addon_id"])
    {
      array_push($user_order_1, $get_user);
    }
    else
    {

      // array_push($reat_set, $get_user["total_reating"]);
      array_push($user_order_2, $get_user);
    }
}
// rsort($user_order_2);
// var_dump($reat_set);
...
$user_order=array_merge($user_order_1,$user_order_2);
// var_dump($user_order_2);
// var_dump($user_order_2);
               for($k=0; $k<count($user_order); $k++) {


               $data=$this->db->query("select * from user_login where USERID='".$user_order[$k]["USERID"]."'")->row_array();
               $profile_image='assets/uploads/default/'.$default_profile_image["name"];
               if(@$data["user_thumb_image"])
               {
                  $profile_image="assets/uploads/".@$data["user_thumb_image"];
