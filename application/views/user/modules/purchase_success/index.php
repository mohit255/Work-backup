							...
							<tr>
								...
								<td>
									...
									<div class="product-group">
										...
										<div class="pro_img">
<?php $user_thumb_image="assets/images/avatar2.jpg";
    if(@$user_image)
    {
    	 $user_thumb_image="assets/uploads/".$user_image;
    } ?>
											<a href="javascript:;"  onclick="purchase_view(<?php echo $purchase_details['id'];?>)" >
			<img src="<?php echo @$user_thumb_image; ?>" style="border-radius: 51px;width: 100px;height: 100px;" class="thumb-sm" alt="<?php echo $purchase_details['fullname'] ; ?>"></a>

										</div>

										<div class="pull-left">

											<h4 class="product-name2"><a href="javascript:;"  onclick="purchase_view(<?php echo $purchase_details['id'];?>)" ><?php echo ucfirst(str_replace("-"," ",$purchase_details['name'])); ?></a></h4> <span class="order_date"><?php echo  $created_on; ?></span> 
				...
				<div class="text-center thanks-cont">
                    ...
                    <a href="<?php echo "user-profile/".$purchase_details['username']; ?>" class="btn btn-primary btn-border">GO TO PROFILE</a> <!--<span class="or-space">or</span>  <a href="<?php echo base_url()."buy-service"; ?>" class="underline-link"> Continue shopping</a> -->
