				...
				<div class="container">				
					...
					<div class="row milestone-section">
						...
						<div class="col-sm-2 text-center">
							...
							<span class="circle-bg orange-bg"><img src="http://work.digimonk.net/assets/images/circle-map.png"></span>
						...
						<div class="col-sm-2 text-center">
							...
							<span class="circle-bg orange-bg"><img src="http://work.digimonk.net/assets/images/publish-icon.png"></span>
						...
						<div class="col-sm-2 text-center">
							...
							<span class="circle-bg orange-bg"><img src="http://work.digimonk.net/assets/images/receive-orders-icon.png"></span>
						...
						<div class="col-sm-2 text-center">
							...
							<span class="circle-bg green-bg"><img src="http://work.digimonk.net/assets/images/deliver-work-icon.png"></span>
						...
						<div class="col-sm-2 text-center">
							...
							<span class="circle-bg green-bg"><img src="http://work.digimonk.net/assets/images/money-bag.png"></span>
						...
						<div class="col-sm-12 text-center">
							...
							<img src="http://work.digimonk.net/assets/images/side-arrow.png">

						</div>

						<div class="col-sm-12">

							<span class="left-arrow"><img src="http://work.digimonk.net/assets/images/down-arrow.png"></span>
	...
	<div class="container">		
		...
		<div class="row">
			...
			<div class="col-md-8">                                                   
				...
				<form id="update_gig"  action="<?php echo base_url()."edit-package/".$basic_details['title']."/".$basic_details['id']; ?>" method="post" class="sell-service-form" enctype= "multipart/form-data" >
			...
			<input type="hidden" name="vimeo_video_id" id="vimeo_video_id" value="<?php echo (!empty($gig_details['vimeo_video_id'])?$gig_details['vimeo_video_id']:'')?>">
					...
					<div class="form-group delivery-day clearfix">
						...
						<input type="text" name="delivering_time" id="delivering_time" class="form-control" value="<?php echo $basic_details['delivering_time'] ;?>"  onkeyup="max_lenght(this)" placeholder="Just type number of days (ex : 2 Days)"><span id="main_delivery_days" class="actual_delivery_days"> 
		 ...
		 <?php echo $rate_symbol; ?><input type="text" class="form-control amount numberonly" id="label_val_1" name="extra_gigs_amount[]"  <?php echo ($allow==1)?'':'readonly'; ?> value="<?php echo $ex_price = $rate; ?>">
			...
			<div class="add-more" <?php if($table_content_row_id>9) { ?>  style="display:none" <?php } ?>>	
				...
				<small class="error_msg help-block extra_gigs_gig_name" style="display: none;">Please enter the package name </small>
					...
					<span class="name-input2"><input name="super_fast_delivery_desc" id="super_fast_delivery_desc"  class="form-control gig-name" placeholder="I can deliver the packages in 2 days" type="text" value="<?php echo (!empty($basic_details['super_fast_delivery_desc']))?$basic_details['super_fast_delivery_desc']:''; ?>"></span>
...
<small class="error_msg help-block terms_conditions_error" style="display: none; margin-bottom: -18px !important;">Please accept terms & conditions</small>	<br>
							<div class="form-group agreement clearfix" style="display: inline-flex;">
									...
									I understand that late delivery will adversely affect my rankings on <span class="sitename2">Digimonk Technologies </span> and will
							...
							<a href="javascript:void(0)" onclick="sell_services_update()" class="btn btn-yellow sell_service_submit"  >
                           Update
							<!-- Post Your Ad -->
						</a> 
