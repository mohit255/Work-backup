...
<section class="profile-section">
                    ...
                    <div class="row">   
                        ...
                        <div class="col-md-12">
                            ...
                            <ol class="breadcrumb menu-breadcrumb">
                                ...
                                <li class="active">My Notification</li>        
 ...
 $get_package_id=$this->db->query("select gigs_id from  payments where id='".$notifications["id"]."'")->row_array();
         ...
         $time_taken =  $total_seconds == 1 ? $total_seconds . ' year ago' : $total_seconds . ' years ago';
            ...
            {      
                ...
                $this->db->update('payments',$data);
                 ...
                 $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">
                    ...
                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$name.'">

                    <strong>'.ucfirst($name).'</strong> <span class="grey-text">has completed the package </span> <strong>'.str_replace("-"," ",$title).'</strong>   
...

            {
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">
                    ...
                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$username.'">
...

            {
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">
                    ...
                    <strong>'.ucfirst($name).'</strong> <span class="grey-text"> purchased your package </span> <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>  
...

            {
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">                    
                    ...
                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$username.'">
                     ...
                     <span class="grey-text">You have made a purchase on a package <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>   from </span> <strong>'.ucfirst($name).'</strong>    
...

            {
                 ...
                 $html = '<li class="list-group-item">
                    ...
                    <strong>'.ucfirst($username).'</strong> <span class="grey-text"> The admin has released payment for package </span> <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>   
...
// var_dump($notifications);
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">                    
                    ...
                    <a href="'.base_url().'package-preview/'.$title.'/'.$get_package_id["gigs_id"].'" class="notify-content">                            

                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$username.'">

                     <span class="grey-text">Admin released payment for a completed package <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>     </span>    
...

            {
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">                    
                    ...
                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$username.'">
                     ...
                     <span class="grey-text"> <strong>'.ucfirst($name).'</strong> cancel the packages of <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>    </span>    
...

            {
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">                    
                    ...
                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$username.'">
                     ...
                     <span class="grey-text"> <strong>'.ucfirst($name).'</strong> decline the packages of <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>    </span>    
...

            {
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">                    
                    ...
                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$username.'">
                     ...
                     <span class="grey-text">Admin released cancel payment for a package <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>     </span>    
...

            {
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">                    
                    ...
                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$username.'">
                     ...
                     <span class="grey-text">Admin released decline payment for a package <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>     </span>    
...

            {
                ...
                $html = '<li id="remove_payments_'.$notifications['id'].'" class="list-group-item">                    
                    ...
                    <img width="40" class="img-circle" src="'.$image.'" alt="'.$username.'">
                     ...
                     <span class="grey-text">Admin released payment for a package <strong>'.ucfirst(str_replace("-"," ",$title)).'</strong>     </span>    
                ...
                echo $html;
                 ...
                 $html = '<li class="list-group-item">
                    ...
                    <p class="text-center m-b-0"> <strong>Sorry !</strong> No Notifications Yet.</span></p>
