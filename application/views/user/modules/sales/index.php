...
$rate_symbol = currency_sign($currency_option);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                	...
                                                	<a href="javascript:;" onclick="sales_view(<?php echo $item['id'];?>)" ><?php echo $item['id'];?></a></td>
                                                ...
                                                <td>
                                                    ...
                                                    <?php }else{?>
                                                    	...
                                                    	<a href="javascript:;" <?php if($status!=7) {
                                                    	 ?> onclick="change_gig_status(<?php echo $item['id'];?>, <?php echo $status;?>);" <?php } ?>><span class="label <?php echo $class;?>"><?php echo $sts;?></span></a>
