				...
				<div class="col-lg-12">
					...
					<div class="card-box">
						...
						<form id="admin_add_cat" action="<?php echo base_url().'admin/user/edit_user/'.$list['USERID']; ?>" method="post"  enctype="multipart/form-data"  >
							...
							<input type="hidden" name="user_username" placeholder="Enter Username" value="<?php if(!empty($list['username'])){echo $list['username']; } ?>" class="form-control" id="user_username" readonly>
<!-- 
							<div class="form-group">
