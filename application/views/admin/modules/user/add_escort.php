...
else
{
 ...
 ?>
   ...
   <input type="hidden" name="redirect_url" value="admin/user/edit_user"> 
...
<input type="hidden" name="user_lofin[types]" value="Escort"> 
  ...
  <div id="avatar_cover" style="background: url(<?php echo @$image_cover; ?>); height: 350px; background-repeat:no-repeat; background-size: 100% 100%; position: relative; -webkit-border-radius: 4px; -moz-border-radius: 4px; border-radius: 4px">
  </div>
   ...
   <div class="user-pic">
     <label class="label">
      ...
      <img src="<?php echo @$image; ?>" id="avatar" style="height: auto;" alt="Escort Admin">
...
?>          
              <div class="row gutter">
   <div class="col-lg-9">
      <div class="panel panel-red"><div class="panel-heading"> 
<div class="row">
  <div class="col-md-4">
    <?php if(!@$agencyid) { ?>
<select class="form-control" required="" name="user_lofin[types]" >
...
<?php } ?>
  ...
  <div class="col-md-8">
    <h4 class="pull-right"><button type="submit" class="btn btn-sm btn-warning btn-add">Create</button></h4>
  </div>
</div>

        </div><div class="panel-body"><div class="tabbable">
...
<div class="row">
  <div class="col-md-6">
    <a href="escort-profile/" target="_blank"><button type="button" class="btn btn-primary">Add New Escort</button></a>
  </div>
</div>
<br><hr><br>
   <div class="row">
...
<?php $set_attr=''; ?>
            ...
            <div class="col-md-4">
               <h4>Contact</h4><p>
                  <input type="text" name="user_lofin[contact]" maxlength="11" placeholder="Contact" class="form-control set_number_only" value=""  required="">
               </p>
            </div>
           </div>
...
<input type="text" name="escort_info[sms_phone_no]" value="" placeholder="HONE FOR SMS ONLY" class="form-control set_number_only">
               </p>
            </div>
            <div class="col-md-4">
               <h4>HEIGHT</h4><p>
         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="panel panel-blue lg-btm-margin">
              ...
              <div class="row">
                 ...
                 <!--  <a><label class="label label-primary label-sm btn" >  
        Add Image
    </label></a> -->
               ...
               <div class="panel-body">
                  <ul class="friends-list clearfix">
                     <li><img src="uploads/user_images/download_100_100.jpg" alt="user" ></li>
                     <li><img src="uploads/user_images/download_100_100.jpg" alt="user" > </li>
                     <!-- <li><img src="assets/img/user20.png" alt="user" data-toggle="modal" data-target="#myModal"></li> -->
                     <li><img src="uploads/user_images/download_100_100.jpg" alt="user" > </li>
                     <li><img src="uploads/user_images/download_100_100.jpg" alt="user" > </li>
                     <li><img src="uploads/user_images/download_100_100.jpg" alt="user" > </li>
                  ...
                  <!-- <h4 class="pull-right">
                  <button type="button" class="btn btn-sm btn-warning btn-add">Upload image</button>
                </h4> -->
               </div>
