			...
			<div class="row">
				...
				<div class="col-lg-12">
					...
					<div class="card-box">
						...
						<form id="admin_add_cat" action="<?php echo base_url().'admin/blog/add_category'; ?>" method="post"  enctype="multipart/form-data"  >
             <input type="hidden" name="table" id="cat_table" value="blog_categories">
             <input type="hidden" name="col_name" id="cat_col" value="name">
