		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-12">
						...
						<?php } ?>
					<h4 class="page-title m-b-20 m-t-0">Manage Packagess</h4>
							...
							<table class="table table-actions-bar datatable table-striped"> 
								...
								<tbody>
									...
									<tr>
										...
										<?php }else{*/ ?>
											<h2 class="text-ellipsis"><a href="<?php echo base_url()."admin/packages/package_preview/".md5($item['gig_id']); ?>" target="_blank" ><?php echo ucfirst(str_replace('-',' ',$item['title'])); ?></a></h2>
										<?php // } ?>	
