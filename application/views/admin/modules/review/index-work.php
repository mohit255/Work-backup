...
<div class="row">
	<div class="col-md-2">
		<select class="form-control" id="get_opertation_for_reviews">
	...
	<div class="col-md-2">
		<button type="button" class="btn btn-sm btn-primary" id="setreview_set">Apply</button>
	</div>
</div>
			<div class="row">
...
<td class="text-right">
											...
											<a href="<?php echo base_url(); ?>admin/review/edit/<?php echo $item["id"]; ?>" class="table-action-btn" title="Edit"><i class="mdi mdi-pencil text-success"></i></a>
