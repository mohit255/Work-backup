...
class User_login_model extends CI_Model{
...

    {
        ...
        $query = $this->db->query("SELECT * FROM `user_login` WHERE (`email` = '$username' OR `username` = '$username') AND `password` = md5('$password') ;");
// var_dump($this->db->last_query());
        ...
        $this->db->update('user_login', array('unique_code' => $unique_code));
        }
